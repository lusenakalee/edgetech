        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-base pl-5 font-semibold leading-6 text-gray-900">Device Repair Form</h3>
              <p className="mt-1 text-sm text-gray-600 ">Fast and Reliable Mobile Phone and Laptop Repairs.</p>
            </div>
          </div>
